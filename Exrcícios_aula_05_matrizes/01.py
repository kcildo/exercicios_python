...
matriz = []
cont = 0
for col in range(4): # loop para preencher as colunas da matriz
    ...
    for lin in range(4): # loop para preencher as linhas da matriz
        ...
        if linha[lin] > 10: # condicional para verificar se o número inserido na linha é maior que 10
